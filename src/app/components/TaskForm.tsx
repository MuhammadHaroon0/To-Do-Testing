            ...
            <div className="flex flex-col space-y-2">
                <div className="flex-1">
                    <input
                        ...
                        className="w-full placeholder:text-black px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                        maxLength={200}
